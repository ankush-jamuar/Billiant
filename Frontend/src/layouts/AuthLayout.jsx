    ...
    <div className="relative min-h-screen overflow-hidden bg-[#0F172A]">
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-6">
        <div className="relative w-full max-w-5xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 rounded-3xl bg-white/10 backdrop-blur-xl shadow-2xl border border-white/20">
            ...
            <div className="hidden lg:flex flex-col justify-between p-12 text-white">
              <div>
                ...
                <Link
                  to="/"
                  className="text-3xl font-semibold tracking-tight hover:opacity-90 transition"
                >
                  Billiant
                </Link>
